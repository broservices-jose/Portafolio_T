...
namespace AppDiagramaClase
{
    public class Persona
    {
          ...
          public bool insertar(string[] dato)
        {
            try
            {
                string miquery = "INSERT INTO Personas( trato, tipo_documento, num_documento, nombre, apellido, sexo, nacimiento, telefono, correo, direccion, nacionalidad) VALUES ('" + dato[0] + "','" + dato[1] + "','" + dato[2] + "','" + dato[3] + "','" + dato[4] + "','" + dato[5] + "','" + dato[6] + "','" + dato[7] + "','" + dato[8] + "','" + dato[9] + "','" + dato[10] + ")'";
